                        ...
                        <Form form={form} name="dynamic_rule"
                            ...
                            >
                                <Input placeholder='Correo'
                                    ...
                                    {/* { formik.errors.email } */}
                                { formik.errors.email && (
                                    <div class="ant-form-item-explain ant-form-item-explain-connected css-w8mnev" role="alert">
                                        <div class="ant-form-item-explain-error">{formik.errors.email}</div>
                                    </div>
                                ) }
                            </Form.Item>
                            <Form.Item
                                ...
                                // {
                                //     required: true,
                                //     message: 'La contraseña es un campo obligatio',
                                // },
                                // ]}
                            ...
                            >
                                ...
                                { formik.errors.password && (
                                    <div class="ant-form-item-explain ant-form-item-explain-connected css-w8mnev" role="alert">
                                        <div class="ant-form-item-explain-error">formik.errors.password</div>
                                    </div>
                                ) }
                            </Form.Item>
                            <Form.Item>
